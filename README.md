...
---> [Đường đi đơn giản](https://docs.google.com/document/d/1wXXQtoBgyMyMXoDWvNZ_CL_fVOns099q4yAPErdebxM/edit) (do anh Trần Quốc Khang soạn, các bạn tham khảo thêm)
...
## 0x04: TÌM THẤY NÓ CHƯA CÁC HUYNH ĐỆ? CHIA NHỎ RA ĐI TÌM TIẾP NÀO. 
#### 1. Tasks:
...
- [Bitwise Operators](https://vjudge.net/problem/CodeChef-NXS2)
...
- [Bitwise Tuples](https://vjudge.net/problem/CodeChef-BITTUP)
- [AND Sorting](https://vjudge.net/problem/CodeForces-1682B)
...
- [MODEX](https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=24&page=show_problem&problem=3671)
...
- [Modular Exponentiation](https://vjudge.net/problem/CodeForces-913A)
- [Factorial Under Modulo](https://vjudge.net/problem/Gym-248968S)
- [Leading and Trailing](https://onlinejudge.org/index.php?option=onlinejudge&page=show_problem&problem=1970)

- [Modular division](https://vjudge.net/problem/EOlymp-9606)
- [Exponentiation II](https://cses.fi/problemset/task/1712)
#### 2. WARNING: Chỉ quan tâm những thứ dưới đây khi đã THỰC SỰ BỎ CUỘC cho một bài nào đó trong phần "Tasks":  
Nếu có một bài nào đó ở phần "Tasks" làm bạn vật vã thì có thể bạn cần một trong những thứ sau đây để khai thông tâm trí:
- [Hint](https://www.youtube.com/watch?v=GU7DpgHINWQ&list=PLl0KD3g-oDOHpWRyyGBUJ9jmul0lUOD80&index=3)
- [Hint](https://cp-algorithms.com/algebra/bit-manipulation.html)
- [Hint](https://codeforces.com/blog/entry/72527)
- [Hint](https://cp-algorithms.com/algebra/binary-exp.html)
- [Hint](https://forthright48.com/modular-multiplicative-inverse/)
- [Hint](https://www.facebook.com/people/CTU-Hacking-Algorithm-Club/61562622140386/)
